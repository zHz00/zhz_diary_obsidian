...
| (3/5) | 2013-11-29, 01:30 | himself | c652855475 |
  ...
  [zHz00](https://zHz00.diary.ru "Untitled")  , я уже сверстал, дальше печать -> "4/6 страниц на листе" ![:)](pics/3.gif) Случайные варианты да, я сделал коммент. К методике выбора вариантов комментариев нет.   
 ^c652855475
